...
const urls = [
  "https://www.funda.nl/zoeken/koop/?price=%22350000-650000%22&sort=%22date_down%22&selected_area=%5B%22utrecht%22,%22utrecht%2Fleidsche-rijn-centrum%22,%22vleuten%22,%22de-meern%22%5D&floor_area=%2275-%22&object_type=%5B%22house%22,%22apartment%22%5D&availability=%5B%22available%22%5D&energy_label=%5B%22A%22,%22B%22,%22C%22,%22A%2B%22,%22A%2B%2B%22,%22A%2B%2B%2B%22,%22A%2B%2B%2B%2B%22,%22A%2B%2B%2B%2B%2B%22%5D",
];
      ...
      if (zipCode) {
        ...
        if (neighbourhoodData) {
          const residentsCount =
            neighbourhoodData?.["AantalInwoners_5"]?.value || 0;
          const westernImmigrantsCount =
            neighbourhoodData?.["WestersTotaal_17"]?.value || 0;
          const nonWesternImmigrantsCount =
            neighbourhoodData?.["NietWestersTotaal_18"]?.value || 0;
          const totalImmigrantsCount =
            westernImmigrantsCount + nonWesternImmigrantsCount;
          const income =
            neighbourhoodData?.["GemiddeldInkomenPerInwoner_66"]?.value * 1000;
          ...
          extraDetails = {
            ...
            residentsAge65AndOlder:
              neighbourhoodData["k_65JaarOfOuder_12"]?.value,
            householdsWithChildren:
              neighbourhoodData["HuishoudensMetKinderen_31"]?.value,
            totalImmigrantsCount,
            shareOfMorocco: convertResidentsToPercentage(
              residentsCount,
              neighbourhoodData["Marokko_19"]?.value
            ),
            shareOfAntillesOrAruba: convertResidentsToPercentage(
              residentsCount,
              neighbourhoodData["NederlandseAntillenEnAruba_20"]?.value
            ),
            shareOfSuriname: convertResidentsToPercentage(
              residentsCount,
              neighbourhoodData["Suriname_21"]?.value
            ),
            shareOfTurkey: convertResidentsToPercentage(
              residentsCount,
              neighbourhoodData["Turkije_22"]?.value
            ),
            shareOfNonImmigrants: convertResidentsToPercentage(
              residentsCount,
              residentsCount - totalImmigrantsCount
            ),
